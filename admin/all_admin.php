...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <!--new code copy-->
 <button type="button"  class="new_button"> <a href="./manage_admin.php">Add New</a></button>
                              ...
                              <table class="table ">
								...
								<tbody>
                                 ...
                                 <tr>
                                       ...
                                       <td> <img src="./slider_images/admin_images/<?php echo $row['image'];  ?>"  style="max-width:100px;"  ></td> 
									   ...
									   <td>
									  <?php echo "<span class='badge badge-edit'><a href='manage_admin.php?id=".$row['id']."'><i class='fa fa-edit'></i></a></span>&nbsp;"; ?>       
