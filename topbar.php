<?php
  ...
  if(isset($_SESSION['USER_LOGIN']))
  {
    ...
    $wishlist_count=mysqli_num_rows(mysqli_query($conn,"SELECT `product`.`pro_name`,`product`.`pro_image`,`product`.`pro_sell_price`,`product`.`pro_mrp`,`wishlist`.`id` FROM `product`,`wishlist` WHERE `wishlist`.`product_id`=`product`.`id` AND `wishlist`.`user_id`='$uid'"));  
  }
  ?>
...
<!-- //header -->
      <div id="top">
        <div class="container">
          <div class="row">
            <div class="col-lg-6 offer mb-3 mb-lg-0"><a href="#" class="btn btn-info btn-sm">Offer of the day</a><a href="#" class="ml-1">Get flat 35% off on orders over $50!</a></div>
            <div class="col-lg-6 text-center text-lg-right">
              <ul class="menu list-inline mb-0">
                <?php 
                  if(isset($_SESSION['USER_LOGIN'])){
                	  echo '<li class="list-inline-item"><a href="./account.php">'.$_SESSION['USER_NAME'].'</a><a href="./logout.php">&nbsp;&nbsp;(Logout)</a></li>';
                	}else{
                		echo '<li class="list-inline-item"><a href="./ragistration.php">Login</a></li><li class="list-inline-item"><a href="ragistration.php">Register</a></li>';
                	}
                ?>   
                <li class="list-inline-item"><a href="contact_us.php">Contact</a></li>
          ...
          <div id="navigation" class="collapse navbar-collapse">
            ...
            <div class="navbar-buttons d-flex justify-content-end">
              ...
              <?php if(isset($_SESSION['USER_LOGIN'])){ ?>
                  ...
                  <a href="wishlist.php" class="btn btn-primary navbar-btn"><i class="fa fa-heart"></i>
                  <span id="wishlist"><?php echo $wishlist_count?></span></a>
                  </div>   
                  <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block">
                  <a href="cart.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i>
                  <span id="carttext"><?php echo $totalProduct?>&nbsp;items</span></a>
                  </div>
              <?php  }else{?>
